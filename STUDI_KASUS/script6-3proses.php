...
<body>
    ...
    $totalDetik1 = $jam1 * 3600 + $menit1 * 60 + $detik1; // menghitung total detik waktu waktu pertama
    $totalDetik2 = $jam2 * 3600 + $menit2 * 60 + $detik2; // menghitung total detik waktu waktu kedua

    $selisih = $totalDetik1 - $totalDetik2; // hitung selisih dalam total detik kedua waktu
